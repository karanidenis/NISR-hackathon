...
def graph5(df_7, df_17):
    ...
    if selected_gender == 'Total':
        ...
        fig_b7.add_trace(go.Bar(
            x=df_b7['Occupation_Group'], y=df_b7['Female'], name='Female', marker_color=teal))
    else:
        # Only include the selected gender data
        fig_b7.add_trace(go.Bar(
            x=df_b7['Occupation_Group'], y=df_b7[selected_gender], name=selected_gender,
            marker_color=light_blue if selected_gender == "Male" else teal))
    ...
    if selected_gender == 'Total':
        ...
        fig_b17.add_trace(go.Bar(
            x=df_b17['Occupation_Group'], y=df_b17['Female'], name='Female', marker_color=teal))
    else:
        # Only include the selected gender data
        fig_b17.add_trace(go.Bar(
